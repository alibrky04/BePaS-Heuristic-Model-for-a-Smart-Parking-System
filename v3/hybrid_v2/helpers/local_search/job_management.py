...
def moveJob(origin_machine: MachineAlien, target_machine: MachineAlien, job_to_move):
...
def swapJobs(origin_machine: MachineAlien, target_machine: MachineAlien, origin_job, target_job):
...
def checkSwapSpan(machine_list, job_list, origin_machine: MachineAlien, target_machine: MachineAlien, origin_job,
                  target_job):
...
def checkMoveSpan(machine_list, job_list, origin_machine: MachineAlien, target_machine: MachineAlien, job_to_move):
    cur_span = calculateMakeSpan(machine_list)
    origin_span = origin_machine.span
    target_span = target_machine.span
    local_max_span = max(origin_span, target_span)
...
def moveColor(origin_machine: MachineAlien, target_machine: MachineAlien, color_to_move):
...
def checkColorChangeSpan(machine_list, origin_machine: MachineAlien, target_machine: MachineAlien, color_to_move):
    cur_span = calculateMakeSpan(machine_list)
    target_span = target_machine.span
...
def isLegalMove(target_machine: MachineAlien, job_type):
...
def swapSim(origin_machine: MachineAlien, target_machine: MachineAlien, origin_job_type, target_job_type):
...
def isLegalSwap(origin_machine: MachineAlien, target_machine: MachineAlien, origin_job_type, target_job_type):
...
def twoSwapSim(origin_machine: MachineAlien, target_machine: MachineAlien, origin_job_type1, origin_job_type2,
               target_job_type1,
               target_job_type2):
    origin_type_hist = origin_machine.types.copy()
    target_type_hist = target_machine.types.copy()
...
def isLegalTwoSwap(origin_machine: MachineAlien, target_machine: MachineAlien, pair1: list, pair2: list):
...
def checkTwoSwapSpan(machine_list, origin_machine: MachineAlien, target_machine: MachineAlien, pair1: list,
                     pair2: list):
    first = (origin_machine.assigned_jobs[pair1[0]])
    second = (origin_machine.assigned_jobs[pair1[1]])
    third = (target_machine.assigned_jobs[pair2[0]])
...
def swapTwoJobs(origin_machine: MachineAlien, target_machine: MachineAlien, pair1: list, pair2: list):
...
def circularSwapSim(machine1: MachineAlien, machine2: MachineAlien, machine3: MachineAlien, job1_type, job2_type,
                    job3_type):
...
def isLegalCircularSwap(machine1: MachineAlien, machine2: MachineAlien, machine3: MachineAlien, job1, job2, job3):
...
def checkCircularSwapSpan(machine_list, machine1: MachineAlien, machine2: MachineAlien, machine3: MachineAlien, job1,
                          job2, job3):
    first = machine1.assigned_jobs[job1]
    second = machine2.assigned_jobs[job2]
    third = machine3.assigned_jobs[job3]
...
def circularSwap(machine1: MachineAlien, machine2: MachineAlien, machine3: MachineAlien, job1, job2, job3):
