...
class MachineAlien(object):
    ...
    def __str__(self):
        ...
        text_string = f"_________Machine numbers : {self.number}_______\n"
        text_string += f"{self.number}\n"
        text_string += f"Assigned Jobs: {self.assigned_jobs}\n"
        text_string += f"Span: {self.span}\n"
        text_string += f"Types: {self.types}\n"
        text_string += f"Types Sums: {self.types_sums}\n"
        return text_string
